...
class PureMF(BasicModel):
    ...
    def replace_pos_items(self, users, pos, neg, need_replace):
    ...
    def bpr_loss(self, users, pos, neg, unique_user=None, pos_item_index=None, pos_item_mask=None):
        ...
        users, neg, replaceable_mask \
            = self.replace_pos_items(users, pos, neg, need_replace)
        # 计算新替换的item的bpr loss
        ...
        return CF1_loss, CF1_reg_loss, CF2_loss, similarity_loss, similarity
